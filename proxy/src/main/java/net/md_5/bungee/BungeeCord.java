...
public class BungeeCord extends ProxyServer
{
    ...
    public BungeeCord() throws IOException
    {
        ...
        getPluginManager().registerCommand(null, new AuthCommand()); //Auth
        getPluginManager().registerCommand(null, new EmailCommand()); //Auth
        getPluginManager().registerCommand(null, new LogoutCommand()); //Auth
    ...
    public void start() throws Exception
    {
        ...
        this.auth = new Auth(sqlConnection); //Hook Auth into Bungee
